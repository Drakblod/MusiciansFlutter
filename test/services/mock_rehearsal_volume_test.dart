...
void main() {
  group('Mock Rehearsal Audio Volume Curve Tests', () {
    ...
    test(
      'Volume just inside 250 km boundary should be approximately 0.10 (minimumAudibleVolume)',
      () {
    ...
    test(
      'Volume should increase smoothly as distance decreases towards source',
      () {
    ...
    test('Secondary non-nearest band volume should be capped at 0.20', () {
      ...
      final volSecondaryAtSource = calculateRehearsalVolume(
        0.0,
        isNearest: false,
      );
